...
export function Post({ post, lang }: PostProps) {
  ...
  return (
    <Link
      ...
      className="flex flex-col hover:bg-neutral-500/5 p-4 rounded-xl ease-out transition-colors cursor-pointer h-full"
    >
      ...
      <div className="flex flex-col gap-3 flex-1">
        ...
        <h2 className="font-semibold text-base leading-tight">{post.title}</h2>
